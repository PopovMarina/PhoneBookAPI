...
String idResult;
    @Test
      ...
      Request request = new Request.Builder()
              .url(ADDCONTACT_PATH).addHeader(AuthorizationHeader, PropertiesReaderXML.getProperty("token"))
...
Request request = new Request.Builder()
        .url(ADDCONTACT_PATH+"/"+idResult)
        .addHeader(AuthorizationHeader, PropertiesReaderXML
                .getProperty("token")).delete().build();
