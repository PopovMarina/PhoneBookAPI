...
/**
 * Это интерфейс TestHelper, который определяет набор
 * констант и объектов, используемых в тестировании.
 */
...
// Объект Gson из библиотеки Google Gson используется для преобразования
// Java объектов в JSON и наоборот.
public static final OkHttpClient client = new OkHttpClient();
// Объект используется для выполнения HTTP запросов
...
// Заголовок авторизации, который используется для отправки токена авторизации в запросах.
